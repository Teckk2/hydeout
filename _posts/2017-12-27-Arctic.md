...
<br>And make sure that Coldfusion only allow two loggin at a time, So if you are unable to loggin then must be there is someone logged in or forget to logout, So revert the machine if you face any issue.
