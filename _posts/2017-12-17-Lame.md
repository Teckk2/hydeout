...
Now we have a non-interactive root shell, anyway It's optional if you really want a tty shell or not for this situation atleast and after that we will read the user and root flags.
...
<br>ls
<br><font color="RoyalBlue">Desktop</font>  <font color="green">reset_logs.sh</font>  root.txt  vnc.log
