...
<br>We got the web **_Meterpreter_** session, run the post migrate command or the meterpreter session will be close after 5 min. Now in able to read the flag first we need to do _Escalate our Privilege_.
