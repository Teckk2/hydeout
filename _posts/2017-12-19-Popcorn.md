...
After uploading the file you will see there is an category _Screenshots_, where we can put an image, So click on edit this torrent and we will use this function to upload our php payload by bypasing the image upload file restriction
