...
<font size="1">
<div style="height:50px;width:600px;overflow:auto;background-color:#262626;color:White;scrollbar-base-color:gold;font-family:monospace;padding:10px;">
...
<br>Make sure our FTP server is up and running,Now download the wget python exploit to the target server and for executiong the exploit we are using authbind for a possible to host something on port 80 , without authbind that wouldn't be possible
