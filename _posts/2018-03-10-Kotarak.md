...
<br>There is no ouput, Maybe the service is running in some internal port,So we need to find the correct internal port first.
...
<br>Thanks my friend **Zc00l** fot helping me in the bash command above, this will ping all the internal port 1 by 1 and if it get's any response it will show it to us.
