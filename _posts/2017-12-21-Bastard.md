...
<br>Now we have the windows meterpreter session, background the session and run the [Windows ClientCopyImage Win32k Exploit](https://www.rapid7.com/db/modules/exploit/windows/local/ms15_051_client_copy_image) and we will get the system level access.
<font size="1">
<div style="height:300px;width:600px;overflow:auto;background-color:#262626;color:White;scrollbar-base-color:gold;font-family:monospace;padding:10px;">
