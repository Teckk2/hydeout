...
<br>And after pasting the php reverse shell make sure to change the **Text format** to **Plain text** and save it.
![format](https://teckk2.github.io/assets/images/Bastard/9-Bastard.JPG)
...
<br>Now open up the listner and after that open the file in new tab.
